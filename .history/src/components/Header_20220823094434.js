...
const navigation = [
  { name: 'Dashboard', href: '../pages/dashboard/index.js', current: true },
  { name: 'Productos', href: '/dashboard/products/', current: false },
  { name: 'Ventas', href: '/edit', current: false },
];
const userNavigation = [
  { name: 'Your Profile', href: '/edit' },
  { name: 'Settings', href: '/edit' },
  { name: 'Sign out', href: '/edit' },
];
